...
const AddJob = () => {
  ...
  const defaultJob = {
    ...
    description:
      "We are looking for a skilled software developer with experience in React and Node.js.",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        userMessage =
          "The system is busy. Your job might still be processing. " +
      ...
      <form onSubmit={handleSubmit} className="job-form">
        ...
        <div className="mb-3">
          ...
          <select
            ...
            required
          >
            <option value="IT">Hospitals</option>
            <option value="HR">Manufacturing & Engineering</option>
            <option value="Sales">
              Retail, Pharma, Jewellery & E-commerce
            </option>
            <option value="Marketing">Healthcare & Pharmaceuticals</option>
            <option value="Finance">
              Preschools & Educational Institutions
            </option>
            <option value="Finance">
              Medical Colleges
            </option>
            <option value="Finance">
              BPO & KPO (Voice, Non-Voice & Backend Ops)
            </option>
            <option value="Finance">
